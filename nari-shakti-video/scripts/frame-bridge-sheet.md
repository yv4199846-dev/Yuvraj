...
Selected Reference Images (Phase 1)
        ↓
Attach the reference images listed under "📎 Reference Images to attach"
        ↓
Generate First-Frame Still using the image-gen prompt in this sheet
        ↓  ← confirm it matches previous part's last frame
...
## Master Quick-Reference — Reference Images per Part

| Part | First-Frame Still | 📎 Reference Images to attach |
|------|-------------------|-------------------------------|
| 1 | Parliament exterior, sunrise | `bg-parliament-exterior-day.png` |
| 2 | Split-screen: rural woman + urban woman | `rural-woman-ref.png` · `urban-woman-ref.png` · `bg-village-home.png` · `bg-city-scene.png` |
| 3 | Parliament interior, cold grey, chaos starts | `bg-parliament-interior-cold.png` · `shadow-figures-ref.png` · `prop-bill-document.png` |
| 4 | Parliament corridor, opposition figure from behind | `opposition-figure-ref.png` · `bg-parliament-interior-cold.png` |
| 5 | Abstract split space, bill document floating | `prop-bill-document.png` · `bg-abstract-split.png` |
| 6 | Three women side by side, deep red background | `rural-woman-ref.png` · `urban-woman-ref.png` · `elderly-woman-ref.png` |
| 7 | Massive women crowd, three women at front | `rural-woman-ref.png` · `urban-woman-ref.png` · `elderly-woman-ref.png` · `prop-women-crowd.png` · `bg-parliament-exterior-night.png` |
...
**📎 Reference Images to attach when generating this still:**
| File | Why needed |
|------|------------|
| `bg-parliament-exterior-day.png` | Sets the exact building design, triangular roof, and warm sunrise palette |
...
| File | Why needed |
|------|------------|
| `pm-figure-ref.png` | PM figure's exact appearance — white kurta, saffron shawl, grey beard, posture |
| `bg-parliament-interior-warm.png` | Parliament chamber layout, benches, arched door, warm golden light |
| `prop-bill-document.png` | The glowing bill document's exact design |
...
fills the scene. Cinematic framing, medium close-up. 
...
| File | Why needed |
|------|------------|
| `rural-woman-ref.png` | Rural woman's exact appearance — saree, sindoor, face, posture |
| `urban-woman-ref.png` | Urban woman's exact appearance — salwar, face, smartphone |
| `bg-village-home.png` | Village home setting — mud walls, small TV |
| `bg-city-scene.png` | City background behind urban woman |
...
zoom begins. 2.5D animated style, cartoon illustration.
```
...
| File | Why needed |
|------|------------|
| `rural-woman-ref.png` | Rural woman's face — same character as Part 2 first frame |
| `urban-woman-ref.png` | Urban woman's face — same character as Part 2 first frame |
...
as earlier frames. 2.5D animated style, cartoon illustration.
```
...
| File | Why needed |
|------|------------|
| `bg-parliament-interior-cold.png` | Parliament interior in cold grey — same chamber layout but dark palette |
| `shadow-figures-ref.png` | Opposition shadow figures beginning to stir on the benches |
| `prop-bill-document.png` | The bill document on the speaker's table |
...
Wide shot from back of chamber. 2.5D animated style, cartoon illustration.
```
...
| File | Why needed |
|------|------------|
| `bg-parliament-interior-cold.png` | Parliament interior cold layout |
| `shadow-figures-ref.png` | Shadow figures in full aggressive chaos posture |
| `prop-bill-document.png` | Bill document on speaker's table |
| `prop-blocked-stamp.png` | Red BLOCKED stamp impression on the document |
...
Wide shot. 2.5D animated style, cartoon illustration.
```
...
| File | Why needed |
|------|------------|
| `opposition-figure-ref.png` | Opposition figure's exact look — white kurta, dark hair, **back/side only** |
| `bg-parliament-interior-cold.png` | Used for the chamber opening visible behind him |

> ⚠️ When attaching `opposition-figure-ref.png` — confirm the reference image itself shows only back/side.  
> If your selected reference shows a face, pick a different variation before proceeding.
...
Cold dark grey palette. IMPORTANT: figure seen from back only — never show the face.
...
| Key detail | Blurred logos visible in background; empty dark centre sets up Part 5's bill |

**📎 Reference Images to attach when generating this still:**
| File | Why needed |
|------|------------|
| `opposition-figure-ref.png` | Edge of figure and his shadow — back view |
...
| Key detail | Bill document floats in same centre-of-frame position as Part 4's empty space |

**📎 Reference Images to attach when generating this still:**
| File | Why needed |
|------|------------|
| `prop-bill-document.png` | The exact bill document design — label, glow, paper appearance |
| `bg-abstract-split.png` | The warm/dark split-space background |
...
| Characters | Shadow arms surround fallen document; rural woman's arm reaches down |
| Color grade | Deep red/dark emerging from split |
| Key detail | Document is ON the ground — surrounded. Red bleed builds toward Part 6. |

**📎 Reference Images to attach when generating this still:**
| File | Why needed |
|------|------------|
| `prop-bill-document.png` | The fallen bill document on the ground |
| `rural-woman-ref.png` | Her arm reaching down from the right side |
| `shadow-figures-ref.png` | Shadow arms pressing down on the document |
| `bg-abstract-split.png` | The split-space environment |
...
Deep red light begins to bleed into the frame from below. 
2.5D animated style, cartoon illustration.
```
...
| Element | Description |
|---------|-------------|
| Setting | Bold solid background — deep red/black |
| Camera position | Wide 3-shot — all three women, full body |
| Characters | Rural woman, Urban woman, Elderly woman side by side |
| Color grade | Deep red pulsing against black |
| Key detail | Continues from Part 5's red bleed — colour transition is seamless |

**📎 Reference Images to attach when generating this still:**
| File | Why needed |
|------|------------|
| `rural-woman-ref.png` | Rural woman's full appearance — saree, sindoor, fierce expression version |
| `urban-woman-ref.png` | Urban woman's full appearance — salwar, determined eyes version |
| `elderly-woman-ref.png` | Elderly woman's full appearance — white saree, silver hair, fierce version |
...
Deep red pulsing background. 2.5D animated style, cartoon illustration.
```
...
| Characters | All three women pointing directly at camera |
| Color grade | Deep red + black |
| Key detail | Crowd hint behind them sets up Part 7's mass crowd shot |

**📎 Reference Images to attach when generating this still:**
| File | Why needed |
|------|------------|
| `rural-woman-ref.png` | Rural woman's face — fierce pointing version |
| `urban-woman-ref.png` | Urban woman's face — fierce pointing version |
| `elderly-woman-ref.png` | Elderly woman's face — fierce pointing version |
...
suggesting the crowd that will fill Part 7. 2.5D animated style, cartoon illustration.
```
...
| Camera position | Wide shot, crowd fills frame edge to edge |
| Characters | Massive crowd of all women types — three from Part 6 are the front row |
| Color grade | Dark sky, crowd is warm and vibrant |
| Key detail | The three women from Part 6 visible at front — visual character continuity |

**📎 Reference Images to attach when generating this still:**
| File | Why needed |
|------|------------|
| `rural-woman-ref.png` | Rural woman visible at front of crowd |
| `urban-woman-ref.png` | Urban woman visible at front of crowd |
| `elderly-woman-ref.png` | Elderly woman visible at front of crowd |
| `prop-women-crowd.png` | Mass crowd of women behind them, filling the frame |
| `bg-parliament-exterior-night.png` | Night Parliament building visible in the distant background |
...
above. India's Parliament building (triangular roof) is faintly visible at 
the horizon in warm light. The crowd is vibrant with warm saree colors 
against the dark sky. Wide establishing shot. 2.5D animated style, cartoon illustration.
```
...
| 4→5 | Figure exited, empty dark centre | Bill floating in centre | Compositional: centre of frame |
...
- [ ] `frames/part-01-first-frame.png` — generated and approved
